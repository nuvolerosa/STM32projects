...
#ifndef TENSORFLOW_LITE_UTIL_TCN_SMALL_DATA_H_
#define TENSORFLOW_LITE_UTIL_TCN_SMALL_DATA_H_

extern const unsigned char tcn_small[];
extern const int tcn_small_len;
