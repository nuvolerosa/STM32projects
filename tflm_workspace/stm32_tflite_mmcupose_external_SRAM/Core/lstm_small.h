...
#ifndef TENSORFLOW_LITE_UTIL_LSTM_SMALL_DATA_H_
#define TENSORFLOW_LITE_UTIL_LSTM_SMALL_DATA_H_

extern const unsigned char lstm_small[];
extern const int lstm_small_len;

#endif  // TENSORFLOW_LITE_UTIL_LSTM_SMALL_DATA_H_
