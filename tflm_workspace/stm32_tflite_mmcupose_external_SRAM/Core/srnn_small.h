...
#ifndef TENSORFLOW_LITE_UTIL_SRNN_SMALL_DATA_H_
#define TENSORFLOW_LITE_UTIL_SRNN_SMALL_DATA_H_

extern const unsigned char srnn_small[];
extern const int srnn_small_len;

#endif  // TENSORFLOW_LITE_UTIL_SRNN_SMALL_DATA_H_
